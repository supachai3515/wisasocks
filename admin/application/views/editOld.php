...
if(!empty($userInfo))
{
    foreach ($userInfo as $uf)
    {
        ...
        $mobile = $uf->mobile;
        $roleId = $uf->roleId;
        $menu_group_id = $uf->menu_group_id;
    }
}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="menu_group_id" name="menu_group_id">
                                            ...
                                            if(!empty($menu_group))
                                            {
                                                ...
                                                {
                                                    ?>
                                                    <option value="<?php echo $row->menu_group_id; ?>" <?php if($row->menu_group_id == $menu_group_id) {echo "selected=selected";} ?>><?php echo $row->name ?></option>>
                                                    <?php
                                                }
                                            }
                                            ?>
